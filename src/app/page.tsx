...
import { MessageCircle, Play, Settings, FileCode, Type, FileText, FileSpreadsheet, FileCog, Link as LinkIcon, FileWarning, Fingerprint, GitCompare, ClipboardList } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link href="/registro-integraciones/tickets">
              <Card className="h-full transition-all duration-200 hover:shadow-lg hover:-translate-y-1 group">
                <CardHeader className="flex flex-col items-center justify-center text-center p-6">
                  <div className="p-4 bg-primary/10 rounded-full mb-4 transition-colors group-hover:bg-primary/20">
                    <ClipboardList className="w-10 h-10 text-primary/80 transition-colors group-hover:text-primary" />
                  </div>
                  <CardTitle className="text-xl">Registro de Integraciones</CardTitle>
                  <CardDescription className="mt-2">
                    Documenta paso a paso las acciones realizadas en cada ticket de integraciones.
                  </CardDescription>
                </CardHeader>
              </Card>
            </Link>
