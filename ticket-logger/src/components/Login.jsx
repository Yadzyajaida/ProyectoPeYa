  ...
  return (
    <div className="panel" style={{ width: '100%', maxWidth: '400px', textAlign: 'center' }}>
      ...
      <p className="text-muted" style={{ marginBottom: '30px' }}>
        Inicia sesión para continuar a Integraciones - ID tracker
      </p>
      
      {error && <div className="alert alert-error" style={{ marginBottom: '20px', color: 'var(--text-white)', backgroundColor: '#ef4444', padding: '10px', borderRadius: '8px' }}>{error}</div>}
