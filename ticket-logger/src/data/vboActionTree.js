...
export const vboVendorManagementMenu = [
  { id: 'vendors', label: 'Vendors', icon: '🏪' },
  { id: 'pos_integrations', label: 'POS Integrations', icon: '🔌' },
];

export const vboVendorSearchOptions = [
...
export const vboDefaultAttributes = [
...
export const vboIntegrationTypes = [
  'POS DIRECT',
  'POS INDIRECT',
  'NON POS (No tiene integración)'
];

export const vboCountries = [
...
export const vboPosSearchOptions = [
  { id: 'search_remote_id', label: 'Por Remote ID' },
  { id: 'search_lpvid', label: 'Por LPVID' }
];

export const vboPosEditOptions = [
