...
// For each one, the agent picks what they did: Crear, Modificar, Borrar, Mover, or skip
...
export const catalogEntityActions = [
...
export const itemsEliminadosEntities = [
